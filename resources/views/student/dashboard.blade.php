                        ...
                        <div class="sidebar-content">
                            ...
                            <div class="card">
                                <div class="card-body bg-indigo-400 text-center card-img-top" style="background-image: url(global_assets/images/backgrounds/panel_bg.png); background-size: contain;">
                                    ...
                                    <span class="d-block opacity-75">Graphic Designer</span>

                                    <div class="list-icons list-icons-extended mt-3">
                                        <a href="#" class="list-icons-item text-white" data-popup="tooltip" title="" data-container="body" data-original-title="Call"><i class="icon-phone2"></i></a>
                                        <a href="#" class="list-icons-item text-white" data-popup="tooltip" title="" data-container="body" data-original-title="WhatsApp"><i class="fab fa-whatsapp" style="font-weight: 600;font-size: 17px;"></i></a>
                                        <a href="#" class="list-icons-item text-white" data-popup="tooltip" title="" data-container="body" data-original-title="Email"><i class="icon-comment"></i></a>
                                    </div>
                                </div>
                                    ...
                                    <ul class="nav nav-sidebar mb-2">
                                        ...
                                        <li class="nav-item">
                                            <a href="#schedule" class="nav-link" data-toggle="tab">
                                                ...
                                                Review
                                                <span class="font-size-sm font-weight-normal opacity-75 ml-auto">4.1 Ratings</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#inbox" class="nav-link" data-toggle="tab">
                                                ...
                                                Q & A
                                                <span class="badge bg-green badge-pill ml-auto">10</span>
                                            </a>
                                        </li>
                                    ...
                                    <form action="#">
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" value="{{$student->username}}" class="form-control">
                                                </div>
                                                <div class="col-md-6">
                                                    <label>Full name</label>
                                                
                                                    <input type="text" value=" {{$student->full_name}}" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" value="{{$student->address_line_1}}" class="form-control">
                                                </div>
                                                <div class="col-md-6">
                                                    <label>Address line 2</label>
                                                    <input type="text" value="{{$student->address_line_2}}" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <label>City</label>
                                                    <input type="text" value="{{$student->city}}" class="form-control">
                                                </div>
                                                <div class="col-md-4">
                                                    <label>State/Province</label>
                                                    <input type="text" value="{{$student->state}}" class="form-control">
                                                </div>
                                                <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <label>Email</label>
                                                    <input type="text" readonly="readonly" value="{{$student->email}}" class="form-control">
                                                </div>
                                                <div class="col-md-6">
                                                    <label>Your country</label>
                                                    <select class="form-control form-control-select2" data-fouc>
                                                        <option value="{{$student->country_id}}" selected>{{$student->country_id}}</option> 
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <label>Phone #</label>
                                                    <input type="text" value="{{$student->phone_number}}" class="form-control">
                                    ...
                                    <form action="#">
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <label>Username</label>
                                                    <input type="text" value="{{$student->username}}" readonly="readonly" class="form-control">
                                                </div>
